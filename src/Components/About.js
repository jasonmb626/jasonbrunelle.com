      ...
      <div className='container'>
        <div className='jumbotron'>
          ...
          <p className='lead'>
            ...
            can benefit anyone on their desktop or mobile.
          </p>
          <hr className='my-4' />
          <p>
            It has been a joy to watch as JavaScript grew from a language we
            tolerated because we didn't have anything better into a language
            that is sought out even for back-end development. I embrace
